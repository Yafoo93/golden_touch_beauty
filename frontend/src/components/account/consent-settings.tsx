...
export function ConsentSettings() {
  ...
  return <form className="consent-settings" onSubmit={submit}>
    ...
    <article>
      <div><p>Images and media</p><h2>Photograph and advertising consent</h2><span>Allow approved photographs or videos taken during your services—including before-and-after images—to be used on the Golden Touch website, social media, portfolio, training materials, and advertisements. Declining or withdrawing consent does not prevent you from receiving a service, and withdrawal hides linked website result images from future display.</span>{consent?.photograph_consent_updated_at ? <small>Last updated {new Date(consent.photograph_consent_updated_at).toLocaleString()}</small> : null}</div>
